                    ...
                    <>
                        <div className="h-12 border-b border-white/5 flex items-center justify-between px-6 shrink-0 shadow-sm font-black bg-white/2 backdrop-blur-md uppercase italic tracking-tighter">
                            ...
                            <div className="flex items-center gap-4">
                                <button onClick={() => setShowSearch(!showSearch)} className={`transition-all p-1.5 rounded-lg ${showSearch ? 'text-purple-400 bg-purple-500/10' : 'text-gray-500 hover:text-white bg-white/5'}`}><FaSearch size={18}/></button>
