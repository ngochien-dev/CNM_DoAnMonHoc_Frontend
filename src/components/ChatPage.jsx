            ...
            <div className={`flex flex-col border-r transition-all duration-300 ${isSidebarVisible ? 'w-60 md:w-72' : 'w-0 overflow-hidden'} ${darkMode ? 'bg-[#1e293b]/50 backdrop-blur-xl border-white/5' : 'bg-slate-50 border-gray-200'}`}>
                ...
                <div className={`h-16 px-3 flex items-center gap-2 border-b shrink-0 ${darkMode ? 'border-white/5' : 'border-gray-200'}`}>
                    ...
                    <div className="flex-1 relative group">
                        <div className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-all border text-xs ${darkMode
                    ...
                    <button
                        ...
                        className={`p-2.5 rounded-xl border transition-all active:scale-90 shrink-0 ${darkMode
                ...
                <div className={`px-3 py-1.5 border-b shrink-0 flex items-center justify-between relative z-30 ${darkMode ? 'border-white/5 bg-white/2' : 'border-gray-200 bg-gray-50/50'}`}>
                    ...
                    <div className="flex items-center gap-3 text-xs font-bold">
                        <button
                            ...
                            className={`py-1.5 px-2 relative transition-all ${activeSidebarTab === 'all'
                        ...
                        <button
                            ...
                            className={`py-1.5 px-2 relative transition-all flex items-center gap-1.5 ${activeSidebarTab === 'unread'
                                ? (darkMode ? 'text-indigo-400' : 'text-indigo-600')
                                : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`flex items-center gap-1 py-1.5 px-2 text-[11px] font-bold rounded-lg transition-all ${darkMode ? 'text-gray-300 hover:bg-white/5' : 'text-slate-600 hover:bg-slate-100'
                                    }`}
                            >
                                        ...
                                        <div className="space-y-0.5">
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-left text-[11px] font-bold transition-all ${activeSidebarTab === item.id
                                                    ...
                                                    {customFolders.map(folder => (
                                                        ...
                                                        >
                                                            <button
                                                                ...
                                                                className={`flex-1 flex items-center px-3 py-2 rounded-xl text-left text-[11px] font-bold transition-all ${activeSidebarTab === folder.id
                                                                    ? (darkMode ? 'bg-indigo-500/20 text-indigo-400 font-extrabold' : 'bg-indigo-50 text-indigo-600 font-extrabold')
                                                                    : (darkMode ? 'hover:bg-white/5 text-gray-300' : 'hover:bg-slate-100 text-slate-700')
                                                                    }`}
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className={`p-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity hover:scale-110 ${darkMode ? 'text-gray-400 hover:text-white hover:bg-white/5' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100'
                                                                    }`}
                                                                title="Sửa thư mục"
                                                            >
                                                                <FaCog size={10} />
                                            ...
                                            <button
                                                ...
                                                className={`w-full flex items-center gap-2 px-3 py-2 rounded-xl text-left text-[10px] font-black uppercase tracking-wider transition-all ${darkMode ? 'text-indigo-400 hover:bg-indigo-500/10' : 'text-indigo-600 hover:bg-indigo-50'
                                                    }`}
                                            >
                        ...
                        <button
                            ...
                            className={`p-1.5 rounded-lg transition-all ${darkMode ? 'text-gray-400 hover:text-white hover:bg-white/5' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100'
                                }`}
                            title="Tạo thư mục"
                        >
                        ...
                        const renderRoom = (r) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`group p-3 rounded-2xl flex items-center gap-3 cursor-pointer mb-1 relative transition-all duration-300 border ${isActive
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-baseline mb-1">
                                            ...
                                            {/* Last message time */}
                                            {timeStr && (
                                                <span className={`text-[9px] font-bold tracking-tight shrink-0 ml-2 ${isActive ? 'text-white/80' : (darkMode ? 'text-gray-400' : 'text-slate-400')
                                                    }`}>
                                                    {timeStr}
                                                </span>
                                            )}
                                                            ...
                                                            {mentionOptions.map(uname => {
                                                                ...
                                                                return (
                                                                    <div
                                                                        ...
                                                                        className={`flex items-center gap-3 px-3 py-2 rounded-xl cursor-pointer transition-all ${darkMode ? 'hover:bg-white/5' : 'hover:bg-slate-50'
                                                                            }`}
                                                                    >
                ...
                <>
                    ...
                    >
                        ...
                        <div className={`relative group/sub w-full flex items-center justify-between px-3 py-2 rounded-xl text-left text-xs font-semibold cursor-pointer transition-colors ${darkMode ? 'hover:bg-white/5' : 'hover:bg-slate-100'
                            ...
                            <div className={`absolute left-full top-0 ml-1.5 hidden group-hover/sub:block w-48 rounded-xl border p-1.5 flex flex-col shadow-xl ${darkMode ? 'bg-[#1e1f22] border-white/10 text-gray-200' : 'bg-white border-gray-200 text-slate-800'
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-left text-[10px] font-bold text-indigo-500 transition-colors ${darkMode ? 'hover:bg-white/5' : 'hover:bg-slate-55'
                                        }`}
                                >
                            ...
                            <div className={`absolute left-full top-0 ml-1.5 hidden group-hover/sub:block w-48 rounded-xl border p-1.5 flex flex-col shadow-xl ${darkMode ? 'bg-[#1e1f22] border-white/10 text-gray-200' : 'bg-white border-gray-200 text-slate-800'
                                ...
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left px-2.5 py-1.5 rounded-lg text-[11px] font-medium transition-colors ${darkMode ? 'hover:bg-white/5' : 'hover:bg-slate-50'
                                            }`}
                                    >
                                        {opt.label}
                                    </button>
                        ...
                        <button
                            ...
                            className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-left text-xs font-semibold transition-colors ${darkMode ? 'hover:bg-white/5 text-gray-400 hover:text-white' : 'hover:bg-slate-100 text-slate-600 hover:text-slate-900'
                                }`}
                        >
