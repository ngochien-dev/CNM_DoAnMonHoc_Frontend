    ...
    return (
        <div className={`w-[72px] hidden sm:flex flex-col items-center py-3 space-y-4 shrink-0 shadow-inner z-20 ${darkMode ? 'bg-[#020617]' : 'bg-white border-r border-gray-200 shadow-sm'}`}>
            ...
            <div className="group relative flex items-center justify-center w-full">
                ...
                <div className="absolute left-16 px-2.5 py-1.5 bg-slate-900/90 text-white text-[11px] font-bold rounded-lg shadow-xl opacity-0 scale-90 pointer-events-none group-hover:opacity-100 group-hover:scale-100 transition-all duration-150 origin-left whitespace-nowrap z-50 border border-white/10">Chat với Người Lạ</div>
            </div>
